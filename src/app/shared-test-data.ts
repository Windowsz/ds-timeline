...
export const OPTION_MAP: OptionMapping[] = [
  ...
  { fcOption: 'locale',                        dsInput: '[locale]',                        notes: "BCP 47 tag (e.g. 'th-TH'). 40+ built-in locales; full UI string i18n + RTL layout.", compatible: 'full' },
  { fcOption: 'locale (object)',               dsInput: '[localeData]',                    notes: "Override or extend built-in locale strings (buttonText, moreLinkText, allDayText, etc.).", compatible: 'full' },
